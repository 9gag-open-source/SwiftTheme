...
extension ThemeManager {
     ...
     */
    public func setThemeWithPlistInMainBundle(_ plistName: String) {
    ...
    /**
        extension for Objective-C, Use setTheme(plistName: String, path: ThemePath) in Swift
     */
    public func setThemeWithPlistInSandbox(_ plistName: String, path: URL) {
     ...
     */
    public func setThemeWithDictInMainBundle(_ dict: NSDictionary) {
    ...
    /**
        extension for Objective-C, Use setTheme(dict: NSDictionary, path: ThemePath) in Swift
     */
    public func setThemeWithDictInSandbox(_ dict: NSDictionary, path: URL) {
