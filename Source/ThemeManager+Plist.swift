...
extension ThemeManager {
    ...
    public func numberForKeyPath(_ keyPath: String) -> NSNumber? {
    ...
    public func dictionaryForKeyPath(_ keyPath: String) -> NSDictionary? {
    ...
    public func colorForKeyPath(_ keyPath: String) -> UIColor? {
    ...
    public func imageForKeyPath(_ keyPath: String) -> UIImage? {
